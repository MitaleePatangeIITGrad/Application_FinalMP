...
<html>
    ...
    <body style="margin:0">
		...
		<div style="height:100px;background-color:LightGray">			
			<div style="width=100%">
				<div style="color:DeepSkyBlue;font-family:'Salsa';font-style:cursive;font-size:100%;font-weight:bold;width:100%;padding-left:10%;">
					Welcome to Imagica Application
				</div>
				<div style="color:DarkSalmon;font-family:'Salsa';font-style:cursive;font-size:100%;font-weight:bold;height:40px;padding-left:20%;">
