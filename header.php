    ...
    <body style="margin:0">
		...
		<div style="height:100px;background-color:97B95A">			
			<div id="text" style="width=95%">
				<div id="headerText" style="color:FFFFCC;width:80%;padding-left:20%;font-family:'Salsa';font-style:cursive;font-size:150%;font-weight:bold;float:left">
					Welcome to Imagica Application
				</div>
				<!-- Tag line-->
				<div id="headerText1" style="color:FFFFCC;padding-left:25%;height:40px;font-family:'Salsa';font-style:cursive;font-size:100%;font-weight:bold;float:left">
